...
<template>
  <section id="projects" class="bg-white py-24 px-6">
    <div class="max-w-5xl mx-auto">
      ...
      <div class="grid gap-6 md:grid-cols-2">
        <div
          ...
          :key="idx"
          class="rounded-xl border border-slate-200 bg-white p-6 flex flex-col hover:border-slate-300 hover:shadow-sm transition-all"
        >
          ...
          <div class="mb-4">
            ...
            <p class="text-sm text-slate-600 italic">{{ project.outcome }}</p>
          </div>
